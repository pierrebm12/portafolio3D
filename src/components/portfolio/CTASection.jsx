        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }}
            ...
            <div className="bg-[#121212] border border-[#F97316]/10 rounded-2xl p-6 sm:p-8">
              ...
              <a href="https://wa.me/573123151897" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-[#121212] border border-[#F97316]/30 text-[#F5EDD6] font-['DM_Sans',sans-serif] font-medium rounded-full hover:bg-[#F97316] hover:text-[#0A0A0A] hover:border-[#F97316] transition-all duration-300">
