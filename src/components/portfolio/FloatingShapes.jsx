...
const configs = [
  { type: 'TorusKnotGeometry', args: [0.5, 0.18, 32, 6], color: '#F97316', emissive: '#EA580C', pos: [-4.5, 2.5, -3], scale: 1 },
  { type: 'IcosahedronGeometry', args: [0.45, 0], color: '#F5EDD6', emissive: '#D4C5A8', pos: [5.5, -2, -4], scale: 1 },
  { type: 'TorusGeometry', args: [0.4, 0.12, 16, 24], color: '#8B5E3C', emissive: '#6B4226', pos: [-3.5, -3.5, -5], scale: 1 },
  ...
  { type: 'TorusKnotGeometry', args: [0.3, 0.1, 24, 4], color: '#F5EDD6', emissive: '#E8D5A3', pos: [3.5, -4, -3], scale: 0.9 },
  ...
  { type: 'TorusGeometry', args: [0.25, 0.06, 12, 18], color: '#6B4226', emissive: '#4A2A16', pos: [-3, 3, -5.5], scale: 1.1 },
